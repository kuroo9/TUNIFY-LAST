...
const Sidebar = () => {
  const navItems = [
    ...
    { to: '/list-song', icon: <ListMusic className="w-5 h-5" />, label: 'List Songs' },
    { to: '/add-album', icon: <FolderPlus className="w-5 h-5" />, label: 'Add Album' },
    { to: '/list-album', icon: <Folders className="w-5 h-5" />, label: 'List Albums' }
  ];
  ...
  return (
    <div className="fixed left-0 top-16 h-[calc(100vh-4rem)] w-[250px] bg-black/80 backdrop-blur-xl border-r border-white/5 px-3 py-6">
      <div className="flex items-center gap-3 px-4 mb-8">
        ...
        <span className="text-lg font-semibold text-white">Tunify Admin</span>
      </div>
