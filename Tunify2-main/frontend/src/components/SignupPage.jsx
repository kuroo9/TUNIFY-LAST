        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div>
                <label htmlFor="firstName" className="block text-sm font-medium text-fuchsia-100 mb-2">
                  First name
                </label>
                <input
                  type="text"
                  ...
                  className={`block w-full px-4 py-3 bg-white/5 border ${errors.firstName ? "border-red-500/50" : "border-fuchsia-500/20"} text-white rounded-lg focus:ring-2 focus:ring-fuchsia-500/50 focus:border-transparent focus:outline-none transition-colors`}
                  placeholder="John"
                />
                {errors.firstName && <p className="mt-2 text-sm text-red-400">{errors.firstName}</p>}
              </div>
              <div>
                <label htmlFor="lastName" className="block text-sm font-medium text-fuchsia-100 mb-2">
                  Last name
                </label>
                <input
                  type="text"
                  ...
                  onChange={handleChange}
                  className={`block w-full px-4 py-3 bg-white/5 border ${errors.lastName ? "border-red-500/50" : "border-fuchsia-500/20"} text-white rounded-lg focus:ring-2 focus:ring-fuchsia-500/50 focus:border-transparent focus:outline-none transition-colors`}
                  placeholder="Doe"
                />
